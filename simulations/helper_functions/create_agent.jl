...
function create_premade_hgf_agent(n_avatars::Int = 4)
    ...
    #create the agent
    agent = init_agent(respond_to_avatar, substruct = hgf, parameters = parameters)
