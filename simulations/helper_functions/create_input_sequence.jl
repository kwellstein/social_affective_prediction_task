...
function create_input_sequence(; avatarProbs, avatarTrials, phaseProb, phaseLength)
    ...
    for phase = 1:nPhases
        ...
        for iNeutralIdx = 1:endNeutralIdx
