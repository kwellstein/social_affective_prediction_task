...
if options.doCluster
    options.sim.saveDir   = '/cluster/home/kwellste/SAP/SAP_data';
    options.files.inputs  = '/cluster/home/kwellste/SAP/SAP_data';
    options.paths.toolbox = '/cluster/home/kwellste/Toolboxes/tapas-6.0.1';
else
    switch stage
        case 'genTraj'
